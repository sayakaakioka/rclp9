...
#include "rclp9_rcljava_time_TimerImpl.h"

JNIEXPORT void JNICALL Java_rclp9_rcljava_time_TimerImpl_nativeCallTimer(JNIEnv *, jclass, jlong wall_timer_handle){
...
JNIEXPORT void JNICALL Java_rclp9_rcljava_time_TimerImpl_nativeDispose(JNIEnv *, jclass, jlong wall_clock_timer_handle){
...
JNIEXPORT jboolean JNICALL Java_rclp9_rcljava_time_TimerImpl_nativeIsReady(JNIEnv *, jclass, jlong wall_timer_handle){
    rcl_timer_t * timer = reinterpret_cast<rcl_timer_t *>(wall_timer_handle);
