...
public class String_publisher {
    public static void main(String[] args) {
        PApplet.runSketch(new String[] { "StringPublisher" }, new StringPublisher());
    }
}

class StringPublisher extends PApplet {
    RCLP9 rclp9 = new RCLP9(this, "rclp9_String_test_publisher");
    ...
    public void setup() {
        ...
        rclp9.createPublisher(std_msgs.msg.String.class, "string_test_topic");
    ...
    void timerCallback() {
        ...
        message.data = "Hello world from publisher!";
