...
public class Quaternion_publisher {
    public static void main(String[] args) {
        PApplet.runSketch(new String[] { "QuaternionPublisher" }, new QuaternionPublisher());
    }
}

class QuaternionPublisher extends PApplet {
    RCLP9 rclp9 = new RCLP9(this, "rclp9_Quaternion_test_publisher");
    ...
    public void setup() {
        ...
        rclp9.createPublisher(geometry_msgs.msg.Quaternion.class, "quaternion_test_topic");
